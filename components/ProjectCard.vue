<template>
  <div>
    <div class="bg-primary-light border-0 rounded-md min-h-full h-96 p-6 flex flex-col">
      <div class="flex gap-x-2 py-3 h-1/6 text-gray-900">
        ...
        <div class="external-link h-5 w-5">
      ...
      <div class="h-4/6">
        ...
        <p class="text-blue-100">A simple Google Keep clone built with Vue and Firebase</p>
      </div>

      <div class="h-1/6 flex gap-x-2 items-end">
        <span class="text-xs uppercase text-blue-400 font-medium">VueJs</span>
        <span class="text-xs uppercase text-blue-400 font-medium">Firebase</span>
      </div>
    </div>
  </div>
</template>
